...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT","core-js/modules/web.immediate.js":"bzsBv","./model.js":"3QBkH","regenerator-runtime/runtime":"f6ot0","./views/recipeView.js":"3wx5k","./views/searchView.js":"kbE4Z","./views/resultsView.js":"kBQ4r"}],"jnFvT":[function(require,module,exports,__globalThis) {
...
const state = {
    ...
    search: {
        query: '',
        results: [],
        resutlsPerPage: (0, _configJs.RESULTS_PER_PAGE),
        currentPage: 1
    }
};
...
const getSearchResultsPage = function(page = state.search.currentPage) {
    ...
    const start = (page - 1) * state.search.resutlsPerPage;
    const end = page * state.search.resutlsPerPage;
